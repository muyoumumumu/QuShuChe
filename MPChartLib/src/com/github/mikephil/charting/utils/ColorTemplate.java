...
public class ColorTemplate {
    ...
    //1色可用
    public static final int[] MYZIDINGYI_COLORS_1 = {
            Color.rgb(92,56,87)
    };
//2色可用
    public static final int[] MYZIDINGYI_COLORS_2 = {
        Color.rgb(92,56,87), Color.rgb(253,165,3)
    };
//4色可用
    public static final int[] MYZIDINGYI_COLORS_4 = {
            Color.rgb(92,56,87), Color.rgb(253,165,3), Color.rgb(31,186,154),
            Color.rgb(80,100,159)
    };
