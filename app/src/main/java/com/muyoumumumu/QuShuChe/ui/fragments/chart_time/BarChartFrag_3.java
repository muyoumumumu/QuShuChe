...
public class BarChartFrag_3 extends Fragment implements OnChartGestureListener,
        OnChartValueSelectedListener {

    public static Fragment newInstance() {
        return new BarChartFrag_3();
    }
...
//        mChart_bar.setMarkerView(mv);
        ...
        //获取内存数据
        ArrayList<Integer> arg= ChartActivity_2.arg_youzhuan;
        ...
        if (mChart_bar.getData() != null &&
            ...
            //chart标签设置
            set1 = new BarDataSet(yVals1, "右转车头时距分布");
...
//        mChart.animateY(2000, Easing.EasingOption.EaseInOutCubic);
        ...
        ArrayList<Integer> y_Vals  = ChartActivity_2.arg_youzhuan;
        ArrayList<Integer> y_Val_l=ChartActivity_2.arg_youzhuan_l;
        ...
        set1_line = new LineDataSet(yVals, "右转交通流率");
