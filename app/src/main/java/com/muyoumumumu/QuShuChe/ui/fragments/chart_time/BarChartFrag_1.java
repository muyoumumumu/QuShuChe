...
public class BarChartFrag_1 extends Fragment implements OnChartGestureListener,
        OnChartValueSelectedListener {

    public static Fragment newInstance() {
        return new BarChartFrag_1();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView img1 = (ImageView) v.findViewById(R.id.imageViewBar);
...
//----------------------------------------------
        ...
        //获取内存数据
        ArrayList<Integer> arg=ChartActivity_2.arg_zhixing;
        ...
        if (mChart_bar.getData() != null &&
            ...
            //chart标签设置
            set1 = new BarDataSet(yVals1, "直行车头时距分布");
...
//        mChart.animateY(2000, Easing.EasingOption.EaseInOutCubic);
        ...
        ArrayList<Integer> y_Vals  = ChartActivity_2.arg_zhixing;
        ArrayList<Integer> y_Val_l=ChartActivity_2.arg_zhixing_l;

        ArrayList<Entry> yVals = new ArrayList<>();


        //注意！！！！！！！！！！！！！！！！！
        //若横轴设置为毫秒为单位 将会非常卡，因此设置0.1秒为横轴单位系数
        ...
        LineDataSet set1_line;
            ...
            set1_line = new LineDataSet(yVals, "直行交通流率");
...
//设值为整数
    ...
    private void  popupmenu() {
        ...
        PopupMenu popupMenu = new PopupMenu(getActivity(), v.findViewById(R.id.imageViewBar));
