...
public class BarChartFrag_4 extends Fragment implements OnChartGestureListener,
        OnChartValueSelectedListener {

    public static Fragment newInstance() {
        return new BarChartFrag_4();
    }
...
//        mChart_bar.setMarkerView(mv);
        ...
        //获取内存数据
        ArrayList<Integer> arg= ChartActivity_2.arg_diaotou;
        ...
        if (mChart_bar.getData() != null &&
            ...
            //chart标签设置
            set1 = new BarDataSet(yVals1, "掉头车头时距分布");
...
//        mChart.animateY(2000, Easing.EasingOption.EaseInOutCubic);
        ...
        ArrayList<Integer> y_Vals  = ChartActivity_2.arg_diaotou;
        ArrayList<Integer> y_Val_l=ChartActivity_2.arg_diaotou_l;
        ...
        set1_line = new LineDataSet(yVals, "掉头交通流率");
