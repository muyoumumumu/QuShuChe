...
public class LineFragment_2 extends Fragment implements SeekBar.OnSeekBarChangeListener,
        OnChartGestureListener, OnChartValueSelectedListener {

    public static Fragment newInstance() {
        return new LineFragment_2();
    }
...
//         mChart.invalidate();
    ...
    private void setData() {
        ...
        for(int i=0;i<y_Vals.size();i++) {
            yVals.add(new Entry(y_Vals.get(i) + y_Vals_2.get(i)+ y_Vals_3.get(i)+ y_Vals_4.get(i), i));
        }

        //dache
        for(int i=0;i<y_Vals_2.size();i++) {
            yVals_2.add(new Entry(y_Vals_5.get(i) + y_Vals_6.get(i)+ y_Vals_7.get(i)+ y_Vals_8.get(i), i));
        }
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(yVals, "小车流量");
            ...
            set2 = new LineDataSet(yVals_2, "大车流量");
            ...
            if (Utils.getSDKInt() >= 18) {
                ...
                set2.setFillColor(ColorTemplate.MYZIDINGYI_COLORS_4[0]);
            }
